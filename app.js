(function () {
  ...
  // ---- navigation ----
  const VIEW_KEYS = ["dashboard", "donow", "checkin", "goals", "insights", "section", "manage", "settings"];
  function renderNav() {
  ...
  async function renderInsights() {
    ...
    renderInsightPatterns(findPatterns(checkins));
    renderInsightBloating(bloatingClusters(checkins));
